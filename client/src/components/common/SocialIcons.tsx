...
// 카카오 아이콘
export const KakaoIcon: React.FC<IconProps> = ({ size = 20, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 네이버 아이콘 (향후 사용 가능)
export const NaverIcon: React.FC<IconProps> = ({ size = 20, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export default { KakaoIcon, GoogleIcon, AppleIcon, NaverIcon };

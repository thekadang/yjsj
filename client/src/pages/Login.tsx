...
const Login: React.FC = () => {
    ...
    const handleLoginSuccess = (user: any) => {
        ...
        // If complete, we just stay on the Login page (or do whatever else is needed)
    };
    ...
    return (
        <>
            ...
            <div style={{ filter: (isMySpaceOpen || isLoginModalOpen || isSignUpModalOpen || isSignUpInfoModalOpen) ? 'blur(5px)' : 'none', transition: 'filter 0.3s ease' }}>
                <LoginHeader
                    onMySpaceClick={() => setIsMySpaceOpen(true)}
            ...
            {/* My Space Modal */}
            <Modal3D isOpen={isMySpaceOpen} onClose={() => setIsMySpaceOpen(false)}>
